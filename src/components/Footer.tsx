  ...
  <footer className="bg-navy text-primary-foreground" role="contentinfo">
    <div className="container py-16">
      <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <span className="mb-4 block font-display text-2xl font-bold text-primary-foreground">ERCA Dienstleistungen</span>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-70">
            <li className="flex items-start gap-2"><MapPin className="mt-0.5 h-4 w-4 shrink-0" aria-hidden="true" /> Juliusstraße 21, 45128 Essen</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 shrink-0" aria-hidden="true" /> <a href="tel:+4915212971388" className="hover:opacity-100 transition-opacity">+49 152 1297 1388</a></li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 shrink-0" aria-hidden="true" /> <a href="mailto:info@erca-service.de" className="hover:opacity-100 transition-opacity">info@erca-service.de</a></li>
            <li className="flex items-center gap-2"><Clock className="h-4 w-4 shrink-0" aria-hidden="true" /> Mo–Fr: 08:00–17:00 Uhr</li>
          </ul>
        </div>
        <div>
      ...
      <div className="mt-14 border-t border-primary-foreground/10 pt-8 text-center text-xs opacity-40">
