      ...
      <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="text-sm leading-relaxed opacity-70">
            Ihr zuverlässiger Partner für erstklassige Immobilienbetreuung. Über 30 Jahre Erfahrung in Essen und Region.
          </p>
        </div>
        <div>
          <h4 className="mb-4 font-display text-sm font-bold uppercase tracking-wider opacity-50">Leistungen</h4>
          <ul className="space-y-2 text-sm opacity-70">
            <li><Link to="/leistungen" className="hover:opacity-100 transition-opacity">Sanierung & Renovierung</Link></li>
            <li><Link to="/leistungen" className="hover:opacity-100 transition-opacity">Heizung & Sanitär</Link></li>
            <li><Link to="/leistungen" className="hover:opacity-100 transition-opacity">Objektbetreuung</Link></li>
            <li><Link to="/leistungen" className="hover:opacity-100 transition-opacity">Gebäudeservice</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-70">
            ...
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 shrink-0" /> <a href="tel:+4915216399326" className="hover:opacity-100 transition-opacity">+49 152 16 39 93 26</a></li>
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <a href="tel:+4915216399326" className="inline-flex items-center gap-2 rounded-md bg-accent px-4 py-2 text-sm font-bold text-accent-foreground">
